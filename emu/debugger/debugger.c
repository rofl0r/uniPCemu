...
void debugger_screen() //Show debugger info on-screen!
{
	...
	for (i=(safe_strlen(debugger_prefix,sizeof(debugger_prefix))+safe_strlen(debugger_command_text,sizeof(debugger_command_text))); i<DEBUGSCREEN_WIDTH-6; i++) //Clear unneeded!
	{
	...
	GPU_textgotoxy(frameratesurface,DEBUGSCREEN_WIDTH-5,debugrow++); //First debug row!
	...
	GPU_textgotoxy(frameratesurface,DEBUGSCREEN_WIDTH-6,debugrow++); //Second debug row!
...
//First: location!
	...
	{
		GPU_textgotoxy(frameratesurface,DEBUGSCREEN_WIDTH-11,debugrow++); //Second debug row!
...
//General purpose registers!
	...
	//Pointers and indexes!
		...
		GPU_textgotoxy(frameratesurface,DEBUGSCREEN_WIDTH-6,GPU_TEXT_DEBUGGERROW+11); //Second debug row!
		GPU_textprintf(frameratesurface,fontcolor,backcolor,"SP:%04X",debuggerregisters.SP); //Debug DX!
		GPU_textgotoxy(frameratesurface,DEBUGSCREEN_WIDTH-6,GPU_TEXT_DEBUGGERROW+12); //Second debug row!
		GPU_textprintf(frameratesurface,fontcolor,backcolor,"BP:%04X",debuggerregisters.BP); //Debug DX!
		GPU_textgotoxy(frameratesurface,DEBUGSCREEN_WIDTH-6,GPU_TEXT_DEBUGGERROW+13); //Second debug row!
		GPU_textprintf(frameratesurface,fontcolor,backcolor,"SI:%04X",debuggerregisters.SI); //Debug DX!
		GPU_textgotoxy(frameratesurface,DEBUGSCREEN_WIDTH-6,GPU_TEXT_DEBUGGERROW+14); //Second debug row!
	...
	//Pointers and indexes!
		...
		GPU_textgotoxy(frameratesurface,DEBUGSCREEN_WIDTH-11,GPU_TEXT_DEBUGGERROW+11); //Second debug row!
		GPU_textprintf(frameratesurface,fontcolor,backcolor,"ESP:%08X",debuggerregisters.ESP); //Debug ESP!
		GPU_textgotoxy(frameratesurface,DEBUGSCREEN_WIDTH-11,GPU_TEXT_DEBUGGERROW+12); //Second debug row!
		GPU_textprintf(frameratesurface,fontcolor,backcolor,"EBP:%08X",debuggerregisters.EBP); //Debug EBP!
		GPU_textgotoxy(frameratesurface,DEBUGSCREEN_WIDTH-11,GPU_TEXT_DEBUGGERROW+13); //Second debug row!
		GPU_textprintf(frameratesurface,fontcolor,backcolor,"ESI:%08X",debuggerregisters.ESI); //Debug ESI!
		GPU_textgotoxy(frameratesurface,DEBUGSCREEN_WIDTH-11,GPU_TEXT_DEBUGGERROW+14); //Second debug row!
...
//Finally, the flags!
	...
	if (EMULATED_CPU<=CPU_80186) //186-?
	{
		GPU_textgotoxy(frameratesurface,DEBUGSCREEN_WIDTH-6,GPU_TEXT_DEBUGGERROW+15); //Second debug row!
		GPU_textprintf(frameratesurface,fontcolor,backcolor,"F :%04X",debuggerregisters.FLAGS); //Debug FLAGS!
	}
	else //286+
	{
		GPU_textgotoxy(frameratesurface,DEBUGSCREEN_WIDTH-10,GPU_TEXT_DEBUGGERROW+15); //Second debug row!
	...
	GPU_textgotoxy(frameratesurface,DEBUGSCREEN_WIDTH-strlen(flags),GPU_TEXT_DEBUGGERROW+16); //Second flags row!
