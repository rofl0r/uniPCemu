...
FLOPPY_GEOMETRY floppygeometries[NUMFLOPPYGEOMETRIES] = { //Differently formatted disks, and their corresponding geometries
	//First, 5"
	{ 160,  8,  1, 40, FLOPPYTYPE_12MB, 0, TRANSFERRATE_250k|(TRANSFERRATE_300k<<2)|(TRANSFERRATE_300k<<4)|(TRANSFERRATE_300k<<6),0xFE,512 , 1, 64 ,DENSITY_SINGLE           ,GAPLENGTH_5_14,0x00   }, //160K 5.25" supports 250kbits, 300kbits SD!
	{ 180,  9,  1, 40, FLOPPYTYPE_12MB, 0, TRANSFERRATE_250k|(TRANSFERRATE_300k<<2)|(TRANSFERRATE_300k<<4)|(TRANSFERRATE_300k<<6),0xFC,512 , 2, 64 ,DENSITY_SINGLE           ,GAPLENGTH_5_14,0x00   }, //180K 5.25" supports 250kbits, 300kbits SD!
	{ 200, 10,  1, 40, FLOPPYTYPE_12MB, 0, TRANSFERRATE_250k|(TRANSFERRATE_300k<<2)|(TRANSFERRATE_300k<<4)|(TRANSFERRATE_300k<<6),0xFC,512 , 2, 64 ,DENSITY_SINGLE           ,GAPLENGTH_5_14,0x00   }, //200K 5.25" supports 250kbits, 300kbits SD!
	{ 320,  8,  2, 40, FLOPPYTYPE_12MB, 0, TRANSFERRATE_250k|(TRANSFERRATE_300k<<2)|(TRANSFERRATE_300k<<4)|(TRANSFERRATE_300k<<6),0xFF,512 , 1, 112,DENSITY_SINGLE           ,GAPLENGTH_5_14,0x00   }, //320K 5.25" supports 250kbits, 300kbits SD!
	{ 360,  9,  2, 40, FLOPPYTYPE_12MB, 0, TRANSFERRATE_250k|(TRANSFERRATE_300k<<2)|(TRANSFERRATE_300k<<4)|(TRANSFERRATE_300k<<6),0xFD,1024, 2, 112,DENSITY_DOUBLE           ,GAPLENGTH_5_14,0x00   }, //360K 5.25" supports 250kbits, 300kbits DD!
	{ 400, 10,  2, 40, FLOPPYTYPE_12MB, 0, TRANSFERRATE_250k|(TRANSFERRATE_300k<<2)|(TRANSFERRATE_300k<<4)|(TRANSFERRATE_300k<<6),0xFD,1024, 2, 112,DENSITY_SINGLE           ,GAPLENGTH_5_14,0x00   }, //400K 5.25" supports 250kbits, 300kbits SD!
	{1200, 15,  2, 80, FLOPPYTYPE_12MB, 0, TRANSFERRATE_250k|(TRANSFERRATE_300k<<2)|(TRANSFERRATE_500k<<4)|(TRANSFERRATE_500k<<6),0xF9,512 , 7, 224,DENSITY_SINGLE           ,GAPLENGTH_5_14,0x00   }, //1200K 5.25" supports 300kbits, 500kbits SD!
	//Now 3.5"
	{ 720,  9,  2, 80, FLOPPYTYPE_720K, 1, TRANSFERRATE_250k|(TRANSFERRATE_300k<<2)|(TRANSFERRATE_300k<<4)|(TRANSFERRATE_300k<<6),0xF9,1024, 3, 112,DENSITY_DOUBLE           ,GAPLENGTH_3_5,0xC0 }, //720K 3.5" supports 250kbits, 300kbits DD! Disable gap length checking here because we need to work without it on a XT?
	{1440, 18,  2, 80, FLOPPYTYPE_14MB, 1, TRANSFERRATE_250k|(TRANSFERRATE_300k<<2)|(TRANSFERRATE_500k<<4)|(TRANSFERRATE_500k<<6),0xF0,512 , 9, 224,DENSITY_IGNORE|DENSITY_HD,GAPLENGTH_3_5,0x80 }, //1.44M 3.5" supports 250kbits, 500kbits HD! Disable gap length checking here because we need to work without it on a XT?
	{1680, 21,  2, 80, FLOPPYTYPE_14MB, 1, TRANSFERRATE_250k|(TRANSFERRATE_500k<<2)|(TRANSFERRATE_500k<<4)|(TRANSFERRATE_500k<<6),0xF0,512 , 9, 224,DENSITY_IGNORE|DENSITY_HD,GAPLENGTH_3_5,0x80    }, //1.68M 3.5" supports 250kbits, 500kbits HD! Supporting BIOS only!
	{1722, 21,  2, 82, FLOPPYTYPE_14MB, 1, TRANSFERRATE_250k|(TRANSFERRATE_500k<<2)|(TRANSFERRATE_500k<<4)|(TRANSFERRATE_500k<<6),0xF0,512 , 9, 224,DENSITY_IGNORE|DENSITY_HD,GAPLENGTH_3_5,0x80    }, //1.722M 3.5" supports 250kbits, 500kbits HD! Supporting BIOS only!
	{1840, 23,  2, 80, FLOPPYTYPE_14MB, 1, TRANSFERRATE_250k|(TRANSFERRATE_500k<<2)|(TRANSFERRATE_500k<<4)|(TRANSFERRATE_500k<<6),0xF0,512 , 9, 224,DENSITY_IGNORE|DENSITY_HD,GAPLENGTH_3_5,0x80    }, //1.84M 3.5" supports 250kbits, 500kbits HD! Supporting BIOS only!
	{2880, 36,  2, 80, FLOPPYTYPE_28MB, 1, TRANSFERRATE_1M|(TRANSFERRATE_1M<<2)|(TRANSFERRATE_1M<<4)|(TRANSFERRATE_1M<<6),        0xF0,1024, 9, 240,DENSITY_IGNORE|DENSITY_ED,GAPLENGTH_IGNORE,0x40 } //2.88M 3.5" supports 1Mbits ED!
};
...
OPTINLINE void FLOPPY_handlereset(byte source) //Resets the floppy disk command when needed!
{
	...
	if ((!FLOPPY_DOR_RESTR) || FLOPPY_DSR_SWRESETR) //We're to reset by either one enabled?
	{
		if (!FLOPPY.floppy_resetted) //Not resetting yet?
		{
			...
			FLOPPY.ST1 = FLOPPY.ST2.data = 0; //Reset the ST data!
