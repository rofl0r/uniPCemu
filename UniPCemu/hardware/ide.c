...
OPTINLINE void ATA_updateStatus(byte channel)
{
	...
	case 0: //Ready for command?
		...
		{
			ATA_STATUSREGISTER_ERRORW(channel, ATA_activeDrive(channel), 0); //Nothing!
