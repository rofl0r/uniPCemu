...
void CPU80386_OP3D() {INLINEREGISTER word theimm = imm32; modrm_generateInstructionTEXT("CMPD EAX,",0,theimm,PARAM_IMM16);/*CMP AX, imm16*/ CMP_dw(REG_EAX,theimm,1);/*CMP AX, imm16*/ }
