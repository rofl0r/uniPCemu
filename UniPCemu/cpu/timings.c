...
CPU_Timings CPUInformation0F[NUMCPUS-CPU_80286][2][0x100] = { //0F information, from 80286 upwards!
	...
	{ //80386+
		{ //16-bit
			...
			{ 1,1,1,1,1,0,1,0x81 }, //A4 SHLD /r r/m16,r16,imm8
			...
			{ 0,0,0,0,0,0,0,0x00 }, //AA STOSB
			{ 1,1,1,1,1,0,0,0x81 }, //AB BTS /r r/m16,r16
			{ 1,1,1,1,1,0,1,0x81 }, //AC SHRD /r r/m16,r16,imm8
			{ 1,1,1,1,1,0,0,0x81 }, //AD SHRD /r r/m16,r16,CL
			{ 0,0,0,0,0,0,0,0x00 }, //AE SCASB
			{ 1,1,1,1,0,1,0,0x01 }, //AF IMUL /r r16,r/m16
			{ 0,0,0,0,0,0,1,0x00 }, //B0 MOV REG,imm8
			{ 0,0,0,0,0,0,1,0x00 }, //B1 MOV REG,imm8
			{ 1,1,1,0,0,1,0,0x00 }, //B2 LSS r16,m16:16
			{ 1,1,1,1,1,0,0,0x81 }, //B3 BTR /r r/m16,r16
			{ 1,1,1,0,0,1,0,0x00 }, //B4 LFS r16,m16:16
			{ 1,1,1,0,0,1,0,0x00 }, //B5 LGS r16,m16:16
			{ 1,1,0x21,5,0,1,0,0x01 }, //B6 MOVZX /r r16,r/m8
			{ 1,1,0x22,6,0,1,0,0x01 }, //B7 MOVZX /r r32,r/m8
			{ 0,0,0,0,0,0,2,0x00 }, //B8 MOV REG,imm16
			{ 0,0,0,0,0,0,2,0x00 }, //B9 MOV REG,imm16
			{ 1,1,1,0,1,0,1,0x481 }, //BA BT* r/m16,imm8(GRP opcode)
			{ 1,1,1,1,1,0,0,0x81 }, //BB BTC /r r/m16,r16
		...
		{ //32-bit
			...
			{ 1,1,2,1,1,0,1,0x81 }, //A4 SHLD /r r/m32,r32,imm8
			{ 1,1,2,1,1,0,0,0x81 }, //A5 SHLD /r r/m32,r32,CL
			{ 0,0,0,0,0,0,0,0x00 }, //A6 CMPSB
			{ 0,0,0,0,0,0,0,0x00 }, //A7 CMPSW
			{ 0,0,0,0,0,0,1,0x00 }, //A8 TESTB AL
			{ 0,0,0,0,0,0,2,0x00 }, //A9 TESTW AX
			{ 0,0,0,0,0,0,0,0x00 }, //AA STOSB
			{ 1,1,2,1,1,0,0,0x81 }, //AB BTS /r r/m32,r32
			{ 1,1,2,1,1,0,1,0x81 }, //AC SHRD /r r/m32,r32,imm8
			{ 1,1,2,1,1,0,0,0x81 }, //AD SHRD /r r/m32,r32,CL
			{ 0,0,0,0,0,0,0,0x00 }, //AE SCASB
			{ 1,1,2,1,0,1,0,0x01 }, //AF IMUL /r r32,r/m32
			{ 0,0,0,0,0,0,1,0x00 }, //B0 MOV REG,imm8
			{ 0,0,0,0,0,0,1,0x00 }, //B1 MOV REG,imm8
			{ 1,1,2,0,0,1,0,0x00 }, //B2 LSS r32,m16:32
			{ 1,1,2,1,1,0,0,0x81 }, //B3 BTR /r r/m32,r32
			{ 1,1,2,0,0,1,0,0x00 }, //B4 LFS r32,m16:32
			{ 1,1,2,0,0,1,0,0x00 }, //B5 LGS r32,m16:32
			{ 1,1,0x22,5,0,1,0,0x01 }, //B6 MOVZX /r r16,r/m8
			{ 1,1,0x42,6,0,1,0,0x01 }, //B7 MOVZX /r r32,r/m16
			{ 0,0,0,0,0,0,2,0x00 }, //B8 MOV REG,imm16
			{ 0,0,0,0,0,0,2,0x00 }, //B9 MOV REG,imm16
			{ 1,1,2,0,1,0,1,0x481 }, //BA BT* r/m32,imm8(GRP opcode)
			{ 1,1,2,1,1,0,0,0x81 }, //BB BTC /r r/m32,r32
