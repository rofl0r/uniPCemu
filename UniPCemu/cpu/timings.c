...
CPU_Timings CPUInformation0F[NUMCPUS-CPU_80286][2][0x100] = { //0F information, from 80286 upwards!
	...
	{ //80386+
		{ //16-bit
			...
			{ 1,1,1,5,0,1,0,0x01 }, //B6 MOVZX /r r16,r/m8
			{ 1,1,2,6,0,1,0,0x01 }, //B7 MOVZX /r r32,r/m8
			{ 0,0,0,0,0,0,2,0x00 }, //B8 MOV REG,imm16
			{ 0,0,0,0,0,0,2,0x00 }, //B9 MOV REG,imm16
			...
			{ 1,1,1,5,0,1,0,0x01 }, //BE MOVSX /r r16,r/m8
			{ 1,1,2,6,0,1,0,0x01 }, //BF MOVSX /r r32,r/m8
			{ 0,1,0,0,0,0,1,0x00 }, //C0 186+ GRP opcode
			{ 0,1,1,0,0,0,1,0x00 }, //C1 186+ GRP opcode
			{ 0,0,0,0,0,0,2,0x00 }, //C2 RET imm16
			{ 0,0,0,0,0,0,0,0x00 }, //C3 RET
		...
		{ //32-bit
			...
			{ 1,1,2,5,0,1,0,0x01 }, //B6 MOVZX /r r16,r/m8
			{ 1,1,2,6,0,1,0,0x01 }, //B7 MOVZX /r r32,r/m16
			{ 0,0,0,0,0,0,2,0x00 }, //B8 MOV REG,imm16
			{ 0,0,0,0,0,0,2,0x00 }, //B9 MOV REG,imm16
			...
			{ 1,1,2,5,0,1,0,0x01 }, //BE MOVSX /r r16,r/m8
			{ 1,1,2,6,0,1,0,0x01 }, //BF MOVSX /r r32,r/m16
			{ 0,1,0,0,0,0,1,0x00 }, //C0 186+ GRP opcode
