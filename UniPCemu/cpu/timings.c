...
CPU_Timings CPUInformation[NUMCPUS][2][0x100] = {
	{
		{ //16-bit!
			...
			{ 1,0,0,0,0,0,2,0x0A }, //A0 MOV AL,[imm16]
			{ 1,0,0,0,0,0,2,0x0A }, //A1 MOV AX,[imm16]
			{ 1,0,0,0,0,0,2,0x0A }, //A2 MOV [imm16],AL
			{ 1,0,0,0,0,0,2,0x0A }, //A3 MOV [imm16],AX
	...
	{ //NEV V30+
		{ //16-bit
			...
			{ 0,0,0,0,0,0,2,0x0A }, //A0 MOV AL,[imm16]
			{ 0,0,0,0,0,0,2,0x0A }, //A1 MOV AX,[imm16]
			{ 0,0,0,0,0,0,2,0x0A }, //A2 MOV [imm16],AL
			{ 0,0,0,0,0,0,2,0x0A }, //A3 MOV [imm16],AX
	...
	{ //80386+
		...
		{ //32-bit
			...
			{ 0,0,0,0,0,0,0,0x00 }, //9E SAHF
			{ 0,0,0,0,0,0,0,0x00 }, //9F LAHF
			{ 1,0,0,0,0,0,3,0x0A }, //A0 MOV AL,[imm32]
			{ 1,0,0,0,0,0,3,0x0A }, //A1 MOV AX,[imm32]
			{ 1,0,0,0,0,0,3,0x0A }, //A2 MOV [imm32],AL
			{ 1,0,0,0,0,0,3,0x0A }, //A3 MOV [imm32],AX
			{ 0,0,0,0,0,0,0,0x00 }, //A4 MOVSB
			{ 0,0,0,0,0,0,0,0x00 }, //A5 MOVSW
			{ 0,0,0,0,0,0,0,0x00 }, //A6 CMPSB
			{ 0,0,0,0,0,0,0,0x00 }, //A7 CMPSW
	...
	{ //80486+
		...
		{ //32-bit
			...
			{ 0,0,0,0,0,0,0,0x00 }, //9E SAHF
			{ 0,0,0,0,0,0,0,0x00 }, //9F LAHF
			{ 0,0,0,0,0,0,3,0x0A }, //A0 MOV AL,[imm16]
			{ 0,0,0,0,0,0,3,0x0A }, //A1 MOV AX,[imm16]
			{ 0,0,0,0,0,0,3,0x0A }, //A2 MOV [imm16],AL
			{ 0,0,0,0,0,0,3,0x0A }, //A3 MOV [imm16],AX
			{ 0,0,0,0,0,0,0,0x00 }, //A4 MOVSB
			{ 0,0,0,0,0,0,0,0x00 }, //A5 MOVSW
			{ 0,0,0,0,0,0,0,0x00 }, //A6 CMPSB
			{ 0,0,0,0,0,0,0,0x00 }, //A7 CMPSW
...
CPU_Timings CPUInformation0F[NUMCPUS-CPU_80286][2][0x100] = { //0F information, from 80286 upwards!
	...
	{ //80386+
		...
		{ //32-bit
			...
			{ 0,0,0,0,0,0,0,0x00 }, //9E SAHF
			{ 0,0,0,0,0,0,0,0x00 }, //9F LAHF
			{ 0,0,0,0,0,0,3,0x0A }, //A0 MOV AL,[imm32]
			{ 0,0,0,0,0,0,3,0x0A }, //A1 MOV AX,[imm32]
			{ 0,0,0,0,0,0,3,0x0A }, //A2 MOV [imm32],AL
			{ 0,0,0,0,0,0,3,0x0A }, //A3 MOV [imm32],AX
			{ 0,0,0,0,0,0,0,0x00 }, //A4 MOVSB
			{ 0,0,0,0,0,0,0,0x00 }, //A5 MOVSW
			{ 0,0,0,0,0,0,0,0x00 }, //A6 CMPSB
			{ 0,0,0,0,0,0,0,0x00 }, //A7 CMPSW
