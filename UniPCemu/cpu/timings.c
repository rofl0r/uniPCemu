...
CPUPM_Timings CPUPMTimings[CPUPMTIMINGS_SIZE] = {
	...
	*/
	...
	//MOV
	,{1,0,0,0x88,0xFE,0x00,{{{{2,0,0},{3-EU_CYCLES_SUBSTRACT_ACCESSWRITE,0,1}}},{{{2,0,0},{3-EU_CYCLES_SUBSTRACT_ACCESSWRITE,0,1}}}}} //MOV Register to Register/Memory
	,{1,0,0,0x8A,0xFE,0x00,{{{{2,0,0},{5-EU_CYCLES_SUBSTRACT_ACCESSREAD,0,1}}},{{{2,0,0},{5-EU_CYCLES_SUBSTRACT_ACCESSREAD,0,1}}}}} //MOV Register/memory to Register
	,{1,0,0,0xC6,0xFE,0x01,{{{{2,0,0},{3-EU_CYCLES_SUBSTRACT_ACCESSWRITE,0,1}}},{{{2,0,0},{3-EU_CYCLES_SUBSTRACT_ACCESSWRITE,0,1}}}}} //MOV Immediate to register/memory
	,{1,0,0,0xB0,0xF0,0x00,{{{{2,0,0},{2,0,0}}},{{{2,0,0},{2,0,0}}}}} //MOV Immediate to register
	,{1,0,0,0xA0,0xFE,0x00,{{{{5,0,0},{5-EU_CYCLES_SUBSTRACT_ACCESSREAD,0,0}}},{{{5,0,0},{5-EU_CYCLES_SUBSTRACT_ACCESSREAD,0,0}}}}} //MOV Memory to accumulator
	,{1,0,0,0xA2,0xFE,0x00,{{{{3,0,0},{3-EU_CYCLES_SUBSTRACT_ACCESSWRITE,0,0}}},{{{3,0,0},{3-EU_CYCLES_SUBSTRACT_ACCESSWRITE,0,0}}}}} //MOV Accumulator to memory
	,{1,0,0,0x8E,0xFF,0x00,{{{{2,0,0},{5-EU_CYCLES_SUBSTRACT_ACCESSREAD,0,1}}},{{{17,0,0},{19-EU_CYCLES_SUBSTRACT_ACCESSREAD,0,1}}}}} //MOV Register/memory to segment register
	,{1,0,0,0x8C,0xFF,0x00,{{{{2,0,0},{3-EU_CYCLES_SUBSTRACT_ACCESSWRITE,0,1}}},{{{2,0,0},{3-EU_CYCLES_SUBSTRACT_ACCESSWRITE,0,1}}}}} //MOV Segment register to register/memory
	//PUSH
	,{1,0,0,0xFF,0xFF,0x07,{{{{5,0,1},{5-EU_CYCLES_SUBSTRACT_ACCESSRW,0,1}}},{{{5,0,1},{5-EU_CYCLES_SUBSTRACT_ACCESSRW,0,1}}}}} //PUSH Memory
	,{1,0,0,0x50,0xF8,0x00,{{{{3,0,0},{3-EU_CYCLES_SUBSTRACT_ACCESSWRITE,0,0}}},{{{3,0,0},{3-EU_CYCLES_SUBSTRACT_ACCESSWRITE,0,0}}}}} //PUSH Register
	,{1,0,0,0x06,0xE7,0x00,{{{{3,0,0},{3-EU_CYCLES_SUBSTRACT_ACCESSWRITE,0,0}}},{{{3,0,0},{3-EU_CYCLES_SUBSTRACT_ACCESSWRITE,0,0}}}}} //PUSH Segment register
	,{1,0,0,0x68,0xFD,0x00,{{{{3,0,0},{3-EU_CYCLES_SUBSTRACT_ACCESSWRITE,0,0}}},{{{3,0,0},{3-EU_CYCLES_SUBSTRACT_ACCESSWRITE,0,0}}}}} //PUSH immediate
	,{1,0,0,0x60,0xFF,0x00,{{{{17-(EU_CYCLES_SUBSTRACT_ACCESSWRITE*8),0,0},{17-(EU_CYCLES_SUBSTRACT_ACCESSWRITE*8),0,0}}},{{{17-(EU_CYCLES_SUBSTRACT_ACCESSWRITE*8),0,0},{17-(EU_CYCLES_SUBSTRACT_ACCESSWRITE*8),0,0}}}}} //PUSHA
	//POP
	,{1,0,0,0x8F,0xFF,0x01,{{{{5-EU_CYCLES_SUBSTRACT_ACCESSREAD,0,1},{5-EU_CYCLES_SUBSTRACT_ACCESSRW,0,1}}},{{{5-EU_CYCLES_SUBSTRACT_ACCESSREAD,0,1},{5-EU_CYCLES_SUBSTRACT_ACCESSRW,0,1}}}}} //POP Memory
	,{1,0,0,0x58,0xF8,0x00,{{{{5-EU_CYCLES_SUBSTRACT_ACCESSREAD,0,0},{5-EU_CYCLES_SUBSTRACT_ACCESSREAD,0,0}}},{{{5-EU_CYCLES_SUBSTRACT_ACCESSREAD,0,0},{5-EU_CYCLES_SUBSTRACT_ACCESSREAD,0,0}}}}} //POP Register
	,{1,0,0,0x07,0xFF,0x00,{{{{5-EU_CYCLES_SUBSTRACT_ACCESSREAD,0,0},{5-EU_CYCLES_SUBSTRACT_ACCESSREAD,0,0}}},{{{20-EU_CYCLES_SUBSTRACT_ACCESSREAD,0,0},{20-EU_CYCLES_SUBSTRACT_ACCESSREAD,0,0}}}}} //POP Segment register
	,{1,0,0,0x17,0xFF,0x00,{{{{5-EU_CYCLES_SUBSTRACT_ACCESSREAD,0,0},{5-EU_CYCLES_SUBSTRACT_ACCESSREAD,0,0}}},{{{20-EU_CYCLES_SUBSTRACT_ACCESSREAD,0,0},{20-EU_CYCLES_SUBSTRACT_ACCESSREAD,0,0}}}}}  //POP Segment register
	,{1,0,0,0x1F,0xFF,0x00,{{{{5-EU_CYCLES_SUBSTRACT_ACCESSREAD,0,0},{5-EU_CYCLES_SUBSTRACT_ACCESSREAD,0,0}}},{{{20-EU_CYCLES_SUBSTRACT_ACCESSREAD,0,0},{20-EU_CYCLES_SUBSTRACT_ACCESSREAD,0,0}}}}} //POP Segment register
	,{1,0,0,0x61,0xFF,0x00,{{{{19-(EU_CYCLES_SUBSTRACT_ACCESSREAD*8),0,0},{19-(EU_CYCLES_SUBSTRACT_ACCESSREAD*8),0,0}}},{{{19-(EU_CYCLES_SUBSTRACT_ACCESSREAD*8),0,0},{19-(EU_CYCLES_SUBSTRACT_ACCESSREAD*8),0,0}}}}} //POPA
	//XCHG
	,{1,0,0,0x86,0xFE,0x00,{{{{3,0,0},{5-EU_CYCLES_SUBSTRACT_ACCESSRW,0,1}}},{{{3,0,0},{5-EU_CYCLES_SUBSTRACT_ACCESSRW,0,1}}}}} //XCHG Register/memory with register
	...
	//LEA
	,{1,0,0,0x8D,0xFF,0x00,{{{{3,0,1},{3,0,1}}},{{{3,0,1},{3,0,1}}}}} //LEA
	//LDS
	,{1,0,0,0xC5,0xFF,0x00,{{{{7,0,1},{7-(EU_CYCLES_SUBSTRACT_ACCESSREAD*2),0,1}}},{{{21,0,1},{21-(EU_CYCLES_SUBSTRACT_ACCESSREAD*2),0,1}}}}} //LDS
	//LES
	,{1,0,0,0xC4,0xFF,0x00,{{{{7,0,1},{7-(EU_CYCLES_SUBSTRACT_ACCESSREAD*2),0,1}}},{{{21,0,1},{21-(EU_CYCLES_SUBSTRACT_ACCESSREAD*2),0,1}}}}} //LES

	//Page 3-48
	//LAHF
	,{1,0,0,0x9F,0xFF,0x00,{{{{2,0,0},{2,0,0}}},{{{2,0,0},{2,0,0}}}}} //LAHF
	//SAHF
	,{1,0,0,0x9E,0xFF,0x00,{{{{2,0,0},{2,0,0}}},{{{2,0,0},{2,0,0}}}}} //SAHF
	//PUSHF
	,{1,0,0,0x9C,0xFF,0x00,{{{{3-EU_CYCLES_SUBSTRACT_ACCESSWRITE,0,0},{3-EU_CYCLES_SUBSTRACT_ACCESSWRITE,0,0}}},{{{3-EU_CYCLES_SUBSTRACT_ACCESSWRITE,0,0},{3-EU_CYCLES_SUBSTRACT_ACCESSWRITE,0,0}}}}} //PUSHF
	//POPF
	...
	//ADD
	,{1,0,0,0x00,0xFC,0x00,{{{{2,0,0},{7-EU_CYCLES_SUBSTRACT_ACCESSRW,0,1}}},{{{2,0,0},{7-EU_CYCLES_SUBSTRACT_ACCESSRW,0,1}}}}} //ADD Reg/memory with register to either
	,{1,0,0,0x80,0xFC,0x01,{{{{3,0,0},{7-EU_CYCLES_SUBSTRACT_ACCESSRW,0,1}}},{{{3,0,0},{7-EU_CYCLES_SUBSTRACT_ACCESSRW,0,1}}}}} //ADD Immediate to register/memory
	,{1,0,0,0x04,0xFE,0x00,{{{{3,0,0},{3,0,0}}},{{{3,0,0},{3,0,0}}}}} //ADD Immediate to accumulator
	//ADC
	,{1,0,0,0x10,0xFC,0x00,{{{{2,0,0},{7-EU_CYCLES_SUBSTRACT_ACCESSRW,0,1}}},{{{2,0,0},{7-EU_CYCLES_SUBSTRACT_ACCESSRW,0,1}}}}} //ADC Reg/memory with register to either
	,{1,0,0,0x80,0xFC,0x03,{{{{3,0,0},{7-EU_CYCLES_SUBSTRACT_ACCESSRW,0,1}}},{{{3,0,0},{7-EU_CYCLES_SUBSTRACT_ACCESSRW,0,1}}}}} //ADC Immediate to register/memory
	,{1,0,0,0x14,0xFE,0x00,{{{{3,0,0},{3,0,0}}},{{{3,0,0},{3,0,0}}}}} //ADC Immediate to accumulator
	//INC
	,{1,0,0,0xFE,0xFE,0x01,{{{{2,0,0},{7-EU_CYCLES_SUBSTRACT_ACCESSRW,0,1}}},{{{2,0,0},{7-EU_CYCLES_SUBSTRACT_ACCESSRW,0,1}}}}} //INC Register/memory
	,{1,0,0,0x40,0xF8,0x00,{{{{2,0,0},{2,0,0}}},{{{2,0,0},{2,0,0}}}}} //INC Register
	//SUB
	,{1,0,0,0x28,0xFC,0x00,{{{{2,0,0},{7-EU_CYCLES_SUBSTRACT_ACCESSRW,0,1}}},{{{2,0,0},{7-EU_CYCLES_SUBSTRACT_ACCESSRW,0,1}}}}} //SUB Reg/memory and register to either
	,{1,0,0,0x80,0xFC,0x06,{{{{3,0,0},{7-EU_CYCLES_SUBSTRACT_ACCESSRW,0,1}}},{{{3,0,0},{7-EU_CYCLES_SUBSTRACT_ACCESSRW,0,1}}}}} //SUB Immediate from register/memory
	,{1,0,0,0x2C,0xFE,0x00,{{{{3,0,0},{3,0,0}}},{{{3,0,0},{3,0,0}}}}} //SUB Immediate from accumulator
	//SBB
	,{1,0,0,0x18,0xFC,0x00,{{{{2,0,0},{7-EU_CYCLES_SUBSTRACT_ACCESSRW,0,1}}},{{{2,0,0},{7-EU_CYCLES_SUBSTRACT_ACCESSRW,0,1}}}}} //SBB Reg/memory and register to either
	,{1,0,0,0x80,0xFC,0x04,{{{{3,0,0},{7-EU_CYCLES_SUBSTRACT_ACCESSRW,0,1}}},{{{3,0,0},{7-EU_CYCLES_SUBSTRACT_ACCESSRW,0,1}}}}} //SBB Immediate from register/memory
	,{1,0,0,0x1C,0xFE,0x00,{{{{3,0,0},{3,0,0}}},{{{3,0,0},{3,0,0}}}}} //SBB Immediate from accumulator
	//DEC
	,{1,0,0,0xFE,0xFE,0x02,{{{{2,0,0},{7-EU_CYCLES_SUBSTRACT_ACCESSRW,0,1}}},{{{2,0,0},{7-EU_CYCLES_SUBSTRACT_ACCESSRW,0,1}}}}} //DEC Register/memory
	,{1,0,0,0x48,0xF8,0x00,{{{{2,0,0},{2,0,0}}},{{{2,0,0},{2,0,0}}}}} //DEC Register
	//CMP
	,{1,0,0,0x3A,0xFE,0x00,{{{{2,0,0},{6-EU_CYCLES_SUBSTRACT_ACCESSREAD,0,1}}},{{{2,0,0},{6-EU_CYCLES_SUBSTRACT_ACCESSREAD,0,1}}}}} //CMP Register/memory with register
	,{1,0,0,0x38,0xFE,0x00,{{{{2,0,0},{7-EU_CYCLES_SUBSTRACT_ACCESSREAD,0,1}}},{{{2,0,0},{7-EU_CYCLES_SUBSTRACT_ACCESSREAD,0,1}}}}} //CMP Register with register/memory
	,{1,0,0,0x80,0xFC,0x08,{{{{3,0,0},{6-EU_CYCLES_SUBSTRACT_ACCESSREAD,0,1}}},{{{3,0,0},{6-EU_CYCLES_SUBSTRACT_ACCESSREAD,0,1}}}}} //CMP Immediate with register/memory
	,{1,0,0,0x3C,0xFE,0x00,{{{{3,0,0},{3,0,0}}},{{{3,0,0},{3,0,0}}}}} //CMP Immediate with accumulator
	//NEG
	,{1,0,0,0xF6,0xFE,0x04,{{{{2,0,0},{2/*-EU_CYCLES_SUBSTRACT_ACCESSRW*/,0,0}}},{{{7,0,1},{7-EU_CYCLES_SUBSTRACT_ACCESSRW,0,1}}}}} //NEG: Can't read/write to memory: negative cycles(4>=2)?
	//AAA
	,{1,0,0,0x37,0xFF,0x00,{{{{3,0,0},{3,0,0}}},{{{3,0,0},{3,0,0}}}}} //AAA
	//DAA
	,{1,0,0,0x27,0xFF,0x00,{{{{3,0,0},{3,0,0}}},{{{3,0,0},{3,0,0}}}}} //DAA

	//Page 3-49
	//AAS
	,{1,0,0,0x3F,0xFF,0x00,{{{{3,0,0},{3,0,0}}},{{{3,0,0},{3,0,0}}}}} //AAS
	//DAS
	,{1,0,0,0x2F,0xFF,0x00,{{{{3,0,0},{3,0,0}}},{{{3,0,0},{3,0,0}}}}} //DAS
	//MUL
	,{1,0,0,0xF6,0xFF,0x05,{{{{13,0,0},{16-EU_CYCLES_SUBSTRACT_ACCESSRW,0,1}}},{{{13,0,0},{16-EU_CYCLES_SUBSTRACT_ACCESSRW,0,1}}}}} //MULB Register/Memory-Byte
	,{1,0,0,0xF7,0xFF,0x05,{{{{21,0,0},{24-EU_CYCLES_SUBSTRACT_ACCESSRW,0,1}}},{{{21,0,0},{24-EU_CYCLES_SUBSTRACT_ACCESSRW,0,1}}}}} //MULW Register/Memory-Word
	//IMUL
	,{1,0,0,0xF6,0xFF,0x06,{{{{13,0,0},{16-EU_CYCLES_SUBSTRACT_ACCESSRW,0,1}}},{{{13,0,0},{16-EU_CYCLES_SUBSTRACT_ACCESSRW,0,1}}}}} //IMULB Register/Memory-Byte
	,{1,0,0,0xF7,0xFF,0x06,{{{{21,0,0},{24-EU_CYCLES_SUBSTRACT_ACCESSRW,0,1}}},{{{21,0,0},{24-EU_CYCLES_SUBSTRACT_ACCESSRW,0,1}}}}} //IMULW Register/Memory-Word
	//IMUL (186+ instruction)
	,{1,0,0,0x69,0xFD,0x00,{{{{21,0,0},{24-EU_CYCLES_SUBSTRACT_ACCESSREAD,0,1}}},{{{21,0,0},{24-EU_CYCLES_SUBSTRACT_ACCESSREAD,0,1}}}}} //IMUL
	//DIV
	,{1,0,0,0xF6,0xFF,0x07,{{{{14,0,0},{17-EU_CYCLES_SUBSTRACT_ACCESSREAD,0,1}}},{{{14,0,0},{17-EU_CYCLES_SUBSTRACT_ACCESSREAD,0,1}}}}} //DIV Register/Memory-Byte
	,{1,0,0,0xF7,0xFF,0x07,{{{{22,0,0},{25-EU_CYCLES_SUBSTRACT_ACCESSREAD,0,1}}},{{{22,0,0},{25-EU_CYCLES_SUBSTRACT_ACCESSREAD,0,1}}}}} //DIV Register/Memory-Word
	//IDIV
	,{1,0,0,0xF6,0xFF,0x08,{{{{17,0,0},{20-EU_CYCLES_SUBSTRACT_ACCESSREAD,0,1}}},{{{17,0,0},{20-EU_CYCLES_SUBSTRACT_ACCESSREAD,0,1}}}}} //IDIV Register/Memory-Byte
	,{1,0,0,0xF7,0xFF,0x08,{{{{25,0,0},{28-EU_CYCLES_SUBSTRACT_ACCESSREAD,0,1}}},{{{25,0,0},{28-EU_CYCLES_SUBSTRACT_ACCESSREAD,0,1}}}}} //IDIV Register/Memory-Word
	//AAM
	,{1,0,0,0xD4,0xFF,0x00,{{{{16,0,0},{16,0,0}}},{{{16,0,0},{16,0,0}}}}} //AAM
	//AAD
	,{1,0,0,0xD5,0xFF,0x00,{{{{14,0,0},{14,0,0}}},{{{14,0,0},{14,0,0}}}}} //AAD
	//CBW
	,{1,0,0,0x98,0xFF,0x00,{{{{2,0,0},{2,0,0}}},{{{2,0,0},{2,0,0}}}}} //CBW
	//CWD
	,{1,0,0,0x99,0xFF,0x00,{{{{2,0,0},{2,0,0}}},{{{2,0,0},{2,0,0}}}}} //CWD
	//Shift/Rotate Instructions
	,{1,0,0,0xD0,0xFE,0x00,{{{{2,0,0},{7-EU_CYCLES_SUBSTRACT_ACCESSRW,0,1}}},{{{2,0,0},{7-EU_CYCLES_SUBSTRACT_ACCESSRW,0,1}}}}} //Shift/Rotate Register/Memory by 1
	,{1,0,0,0xD2,0xFE,0x00,{{{{5,1,0},{8-EU_CYCLES_SUBSTRACT_ACCESSRW,1,1}}},{{{5,1,0},{8-EU_CYCLES_SUBSTRACT_ACCESSRW,1,1}}}}} //Shift/Rotate Register/Memory by CL
	,{1,0,0,0xC0,0xFE,0x00,{{{{5,1,0},{8-EU_CYCLES_SUBSTRACT_ACCESSRW,1,1}}},{{{5,1,0},{8-EU_CYCLES_SUBSTRACT_ACCESSRW,1,1}}}}} //Shift/Rotate Register/Memory by Count
	...
	//CMPS
	,{1,0,0,0xA6,0xFE,0x00,{{{{8-(EU_CYCLES_SUBSTRACT_ACCESSREAD*2),0,0},{8-(EU_CYCLES_SUBSTRACT_ACCESSREAD*2),0,0}}},{{{8-(EU_CYCLES_SUBSTRACT_ACCESSREAD*2),0,0},{8-(EU_CYCLES_SUBSTRACT_ACCESSREAD*2),0,0}}}}} //CMPS
	//SCAS
	...
	//STOS
	,{1,0,0,0xAA,0xFE,0x00,{{{{3-EU_CYCLES_SUBSTRACT_ACCESSWRITE,0,0},{3-EU_CYCLES_SUBSTRACT_ACCESSWRITE,0,0}}},{{{3-EU_CYCLES_SUBSTRACT_ACCESSWRITE,0,0},{3-EU_CYCLES_SUBSTRACT_ACCESSWRITE,0,0}}}}} //STOS
	//INS
	,{1,0,0,0x6C,0xFE,0x00,{{{{5-EU_CYCLES_SUBSTRACT_ACCESSRW,0,0},{5-EU_CYCLES_SUBSTRACT_ACCESSRW,0,0}}},{{{5-EU_CYCLES_SUBSTRACT_ACCESSRW,0,0},{5-EU_CYCLES_SUBSTRACT_ACCESSRW,0,0}}}}} //INS
	//OUTS
	,{1,0,0,0x6E,0xFE,0x00,{{{{5-EU_CYCLES_SUBSTRACT_ACCESSRW,0,0},{5-EU_CYCLES_SUBSTRACT_ACCESSRW,0,0}}},{{{5-EU_CYCLES_SUBSTRACT_ACCESSRW,0,0},{5-EU_CYCLES_SUBSTRACT_ACCESSRW,0,0}}}}} //OUTS
	...
	//STOS
	,{1,0,0,0xAA,0xFE,0x00,{{{{4-EU_CYCLES_SUBSTRACT_ACCESSWRITE,3,2},{4-EU_CYCLES_SUBSTRACT_ACCESSWRITE,3,2}}},{{{4-EU_CYCLES_SUBSTRACT_ACCESSWRITE,3,2},{4-EU_CYCLES_SUBSTRACT_ACCESSWRITE,3,2}}}}} //STOS
	//INS
	,{1,0,0,0x6C,0xFE,0x00,{{{{5-EU_CYCLES_SUBSTRACT_ACCESSRW,4,2},{5-EU_CYCLES_SUBSTRACT_ACCESSRW,4,2}}},{{{5-EU_CYCLES_SUBSTRACT_ACCESSRW,4,2},{5-EU_CYCLES_SUBSTRACT_ACCESSRW,4,2}}}}} //INS
	//OUTS
	...
	//LTR
	,{1,0,1,0x00,0xFF,0x04,{{{{0,0,0},{0,0,0}}},{{{17,0,1},{19-EU_CYCLES_SUBSTRACT_ACCESSREAD,0,1}}}}} //LTR
	//STR
	,{1,0,1,0x00,0xFF,0x02,{{{{0,0,0},{0,0,0}}},{{{2,0,1},{3-EU_CYCLES_SUBSTRACT_ACCESSWRITE,0,1}}}}} //STR
	//LMSW
	,{1,0,1,0x01,0xFF,0x07,{{{{3,0,0},{6-EU_CYCLES_SUBSTRACT_ACCESSREAD,0,1}}},{{{3,0,0},{6-EU_CYCLES_SUBSTRACT_ACCESSREAD,0,1}}}}} //LMSW
	//SMSW
	,{1,0,1,0x01,0xFF,0x05,{{{{2,0,0},{3-EU_CYCLES_SUBSTRACT_ACCESSWRITE,0,1}}},{{{2,0,0},{3-EU_CYCLES_SUBSTRACT_ACCESSWRITE,0,1}}}}} //SMSW
	//LAR
	,{1,0,1,0x02,0xFF,0x00,{{{{0,0,0},{0,0,0}}},{{{14,0,0},{16-EU_CYCLES_SUBSTRACT_ACCESSREAD,0,1}}}}} //LAR
	//LSL
	,{1,0,1,0x03,0xFF,0x00,{{{{0,0,0},{0,0,0}}},{{{14,0,0},{16-EU_CYCLES_SUBSTRACT_ACCESSREAD,0,1}}}}} //LSL
	//ARPL
	,{1,0,0,0x63,0xFF,0x00,{{{{0,0,0},{0,0,0}}},{{{14-EU_CYCLES_SUBSTRACT_ACCESSREAD,0,1},{11-EU_CYCLES_SUBSTRACT_ACCESSREAD,0,1}}}}} //ARPL
	//VERR
	,{1,0,1,0x00,0xFF,0x05,{{{{0,0,0},{0,0,0}}},{{{14,0,0},{16-EU_CYCLES_SUBSTRACT_ACCESSREAD,0,1}}}}} //VERR
	//VERW
