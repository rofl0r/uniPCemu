...
typedef struct PACKED
{
	...
	byte instructionstep, internalinstructionstep, internalmodrmstep, stackchecked; //Step we're at, executing the instruction that's fetched and loaded to execute.
