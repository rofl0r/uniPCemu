...
void CPU8086_OP00() {modrm_readparams(&params,0,0); modrm_generateInstructionTEXT("ADDB",8,0,PARAM_MODRM21); MODRM_src0 = 1; CPU8086_internal_ADD8(modrm_addr8(&params,1,0),modrm_read8(&params,0),2); }
void CPU8086_OP01() {modrm_readparams(&params,1,0); modrm_generateInstructionTEXT("ADDW",16,0,PARAM_MODRM21); MODRM_src0 = 1; CPU8086_internal_ADD16(modrm_addr16(&params,1,0),modrm_read16(&params,0),2); }
void CPU8086_OP02() {modrm_readparams(&params,0,0); modrm_generateInstructionTEXT("ADDB",8,0,PARAM_MODRM12); MODRM_src0 = 0; CPU8086_internal_ADD8(modrm_addr8(&params,0,0),modrm_read8(&params,1),2); }
void CPU8086_OP03() {modrm_readparams(&params,1,0); modrm_generateInstructionTEXT("ADDW",16,0,PARAM_MODRM12); MODRM_src0 = 0; CPU8086_internal_ADD16(modrm_addr16(&params,0,0),modrm_read16(&params,1),2); }
void CPU8086_OP04() {INLINEREGISTER byte theimm = CPU_readOP(); modrm_generateInstructionTEXT("ADDB AL,",0,theimm,PARAM_IMM8); CPU8086_internal_ADD8(&REG_AL,theimm,1); }
void CPU8086_OP05() {INLINEREGISTER word theimm = CPU_readOPw(); modrm_generateInstructionTEXT("ADDW AX,",0,theimm,PARAM_IMM16); CPU8086_internal_ADD16(&REG_AX,theimm,1); }
...
void CPU8086_OP08() {modrm_readparams(&params,0,0); modrm_generateInstructionTEXT("ORB",8,0,PARAM_MODRM21); MODRM_src0 = 1; CPU8086_internal_OR8(modrm_addr8(&params,1,0),modrm_read8(&params,0),2); }
void CPU8086_OP09() {modrm_readparams(&params,1,0); modrm_generateInstructionTEXT("ORW",16,0,PARAM_MODRM21); MODRM_src0 = 1; CPU8086_internal_OR16(modrm_addr16(&params,1,0),modrm_read16(&params,0),2); }
void CPU8086_OP0A() {modrm_readparams(&params,0,0); modrm_generateInstructionTEXT("ORB",8,0,PARAM_MODRM12); MODRM_src0 = 0; CPU8086_internal_OR8(modrm_addr8(&params,0,0),modrm_read8(&params,1),2); }
...
void CPU8086_OP1B() {modrm_readparams(&params,1,0); modrm_debugger16(&params,0,1); modrm_generateInstructionTEXT("SBBW",16,0,PARAM_MODRM12); MODRM_src0 = 0; CPU8086_internal_SBB16(modrm_addr16(&params,0,0),(modrm_read16(&params,1)),2); }
...
void CPU8086_OP23() {modrm_readparams(&params,1,0); modrm_debugger16(&params,0,1); modrm_generateInstructionTEXT("ANDW",16,0,PARAM_MODRM12); MODRM_src0 = 0; CPU8086_internal_AND16(modrm_addr16(&params,0,0),modrm_read16(&params,1),2); }
void CPU8086_OP24() {INLINEREGISTER byte theimm = CPU_readOP(); modrm_generateInstructionTEXT("AND AL,",0,theimm,PARAM_IMM8); CPU8086_internal_AND8(&REG_AL,theimm,1); }
void CPU8086_OP25() {INLINEREGISTER word theimm = CPU_readOPw(); modrm_generateInstructionTEXT("AND AX,",0,theimm,PARAM_IMM16); CPU8086_internal_AND16(&REG_AX,theimm,1); }
void CPU8086_OP27() {modrm_generateInstructionTEXT("DAA",0,0,PARAM_NONE);/*DAA?*/ CPU8086_internal_DAA();/*DAA?*/ }
void CPU8086_OP28() {modrm_readparams(&params,0,0); modrm_debugger8(&params,0,1); modrm_generateInstructionTEXT("SUBB",8,0,PARAM_MODRM21); MODRM_src0 = 1; CPU8086_internal_SUB8(modrm_addr8(&params,1,0),(modrm_read8(&params,0)),2); }
void CPU8086_OP29() {modrm_readparams(&params,1,0); modrm_debugger16(&params,0,1); modrm_generateInstructionTEXT("SUBW",16,0,PARAM_MODRM21); MODRM_src0 = 1; CPU8086_internal_SUB16(modrm_addr16(&params,1,0),(modrm_read16(&params,0)),2); }
void CPU8086_OP2A() {modrm_readparams(&params,0,0); modrm_debugger8(&params,0,1); modrm_generateInstructionTEXT("SUBB",8,0,PARAM_MODRM12); MODRM_src0 = 0; CPU8086_internal_SUB8(modrm_addr8(&params,0,0),(modrm_read8(&params,1)),2); }
void CPU8086_OP2B() {modrm_readparams(&params,1,0); modrm_debugger16(&params,0,1); modrm_generateInstructionTEXT("SUBW",16,0,PARAM_MODRM12); MODRM_src0 = 0; CPU8086_internal_SUB16(modrm_addr16(&params,0,0),(modrm_read16(&params,1)),2); }
void CPU8086_OP2C() {INLINEREGISTER byte theimm = CPU_readOP(); modrm_generateInstructionTEXT("SUB AL,",0,theimm,PARAM_IMM8);/*4=AL,imm8*/ CPU8086_internal_SUB8(&REG_AL,theimm,1);/*4=AL,imm8*/ }
void CPU8086_OP2D() {INLINEREGISTER word theimm = CPU_readOPw(); modrm_generateInstructionTEXT("SUB AX,",0,theimm,PARAM_IMM16);/*5=AX,imm16*/ CPU8086_internal_SUB16(&REG_AX,theimm,1);/*5=AX,imm16*/ }
void CPU8086_OP2F() {modrm_generateInstructionTEXT("DAS",0,0,PARAM_NONE);/*DAS?*/ CPU8086_internal_DAS();/*DAS?*/ }
void CPU8086_OP30() {modrm_readparams(&params,0,0); modrm_debugger8(&params,0,1); modrm_generateInstructionTEXT("XORB",8,0,PARAM_MODRM21); MODRM_src0 = 1; CPU8086_internal_XOR8(modrm_addr8(&params,1,0),modrm_read8(&params,0),2); }
void CPU8086_OP31() {modrm_readparams(&params,1,0); modrm_debugger16(&params,0,1); modrm_generateInstructionTEXT("XORW",16,0,PARAM_MODRM21); MODRM_src0 = 1; CPU8086_internal_XOR16(modrm_addr16(&params,1,0),modrm_read16(&params,0),2); }
void CPU8086_OP32() {modrm_readparams(&params,0,0); modrm_debugger8(&params,0,1); modrm_generateInstructionTEXT("XORB",8,0,PARAM_MODRM12); MODRM_src0 = 0; CPU8086_internal_XOR8(modrm_addr8(&params,0,0),modrm_read8(&params,1),2); }
void CPU8086_OP33() {modrm_readparams(&params,1,0); modrm_debugger16(&params,0,1); modrm_generateInstructionTEXT("XORW",16,0,PARAM_MODRM12); MODRM_src0 = 0; CPU8086_internal_XOR16(modrm_addr16(&params,0,0),modrm_read16(&params,1),2); }
void CPU8086_OP34() {INLINEREGISTER byte theimm = CPU_readOP(); modrm_generateInstructionTEXT("XOR AL,",0,theimm,PARAM_IMM8); CPU8086_internal_XOR8(&REG_AL,theimm,1); }
void CPU8086_OP35() {INLINEREGISTER word theimm = CPU_readOPw(); modrm_generateInstructionTEXT("XOR AX,",0,theimm,PARAM_IMM16); CPU8086_internal_XOR16(&REG_AX,theimm,1); }
void CPU8086_OP37() {modrm_generateInstructionTEXT("AAA",0,0,PARAM_NONE);/*AAA?*/ CPU8086_internal_AAA();/*AAA?*/ }
void CPU8086_OP38() {modrm_readparams(&params,0,0); modrm_debugger8(&params,0,1); modrm_generateInstructionTEXT("CMPB",8,0,PARAM_MODRM21); CMP_b(modrm_read8(&params,1),modrm_read8(&params,0),2); }
void CPU8086_OP39() {modrm_readparams(&params,1,0); modrm_debugger16(&params,0,1); modrm_generateInstructionTEXT("CMPW",16,0,PARAM_MODRM21); CMP_w(modrm_read16(&params,1),modrm_read16(&params,0),2); }
void CPU8086_OP3A() {modrm_readparams(&params,0,0); modrm_debugger8(&params,0,1); modrm_generateInstructionTEXT("CMPB",8,0,PARAM_MODRM12); CMP_b(modrm_read8(&params,0),modrm_read8(&params,1),2); }
void CPU8086_OP3B() {modrm_readparams(&params,1,0); modrm_debugger16(&params,0,1); modrm_generateInstructionTEXT("CMPW",16,0,PARAM_MODRM12); CMP_w(modrm_read16(&params,0),modrm_read16(&params,1),2); }
void CPU8086_OP3C() {INLINEREGISTER byte theimm = CPU_readOP(); modrm_generateInstructionTEXT("CMP AL,",0,theimm,PARAM_IMM8);/*CMP AL, imm8*/ CMP_b(REG_AL,theimm,1);/*CMP AL, imm8*/ }
void CPU8086_OP3D() {INLINEREGISTER word theimm = CPU_readOPw(); modrm_generateInstructionTEXT("CMP AX,",0,theimm,PARAM_IMM16);/*CMP AX, imm16*/ CMP_w(REG_AX,theimm,1);/*CMP AX, imm16*/ }
...
void CPU8086_OP73() {INLINEREGISTER signed char rel8;/*JNC rel8 : (FLAG_CF=0)*/ rel8 = imm8(); modrm_generateInstructionTEXT("JNC",0,REG_IP + rel8,PARAM_IMM16); /* JUMP to destination? */ if (!FLAG_CF) {REG_IP += rel8; /* JUMP to destination? */ CPU_flushPIQ(); /*We're jumping to another address*/ CPU[activeCPU].cycles_OP = 16; /* Branch taken */} else { CPU[activeCPU].cycles_OP = 4; /* Branch not taken */} }
void CPU8086_OP74() {INLINEREGISTER signed char rel8;/*JZ rel8: (FLAG_ZF=1)*/ rel8 = imm8(); modrm_generateInstructionTEXT("JZ",0,REG_IP + rel8,PARAM_IMM16); /* JUMP to destination? */ if (FLAG_ZF) {REG_IP += rel8; /* JUMP to destination? */ CPU_flushPIQ(); /*We're jumping to another address*/ CPU[activeCPU].cycles_OP = 16; /* Branch taken */} else { CPU[activeCPU].cycles_OP = 4; /* Branch not taken */} }
void CPU8086_OP75() {INLINEREGISTER signed char rel8;/*JNZ rel8 : (FLAG_ZF=0)*/ rel8 = imm8(); modrm_generateInstructionTEXT("JNZ",0,REG_IP + rel8,PARAM_IMM16); /* JUMP to destination? */ if (!FLAG_ZF) {REG_IP += rel8; /* JUMP to destination? */ CPU_flushPIQ(); /*We're jumping to another address*/ CPU[activeCPU].cycles_OP = 16; /* Branch taken */} else { CPU[activeCPU].cycles_OP = 4; /* Branch not taken */} }
void CPU8086_OP76() {INLINEREGISTER signed char rel8;/*JBE rel8 : (FLAG_CF=1|FLAG_ZF=1)*/ rel8 = imm8(); modrm_generateInstructionTEXT("JBE",0,REG_IP + rel8,PARAM_IMM16); /* JUMP to destination? */ if (FLAG_CF||FLAG_ZF) {REG_IP += rel8; /* JUMP to destination? */ CPU_flushPIQ(); /*We're jumping to another address*/ CPU[activeCPU].cycles_OP = 16; /* Branch taken */} else { CPU[activeCPU].cycles_OP = 4; /* Branch not taken */} }
void CPU8086_OP77() {INLINEREGISTER signed char rel8;/*JA rel8: (FLAG_CF=0&FLAG_ZF=0)*/ rel8 = imm8(); modrm_generateInstructionTEXT("JA",0,REG_IP + rel8,PARAM_IMM16); /* JUMP to destination? */ if (!FLAG_CF && !FLAG_ZF) {REG_IP += rel8; /* JUMP to destination? */ CPU_flushPIQ(); /*We're jumping to another address*/ CPU[activeCPU].cycles_OP = 16; /* Branch taken */} else { CPU[activeCPU].cycles_OP = 4; /* Branch not taken */} }
void CPU8086_OP78() {INLINEREGISTER signed char rel8;/*JS rel8: (FLAG_SF=1)*/ rel8 = imm8(); modrm_generateInstructionTEXT("JS",0,REG_IP + rel8,PARAM_IMM16); /* JUMP to destination? */ if (FLAG_SF) {REG_IP += rel8; /* JUMP to destination? */ CPU_flushPIQ(); /*We're jumping to another address*/ CPU[activeCPU].cycles_OP = 16; /* Branch taken */} else { CPU[activeCPU].cycles_OP = 4; /* Branch not taken */} }
void CPU8086_OP79() {INLINEREGISTER signed char rel8;/*JNS rel8 : (FLAG_SF=0)*/ rel8 = imm8(); modrm_generateInstructionTEXT("JNS",0,REG_IP + rel8,PARAM_IMM16); /* JUMP to destination? */ if (!FLAG_SF) {REG_IP += rel8; /* JUMP to destination? */ CPU_flushPIQ(); /*We're jumping to another address*/ CPU[activeCPU].cycles_OP = 16; /* Branch taken */} else { CPU[activeCPU].cycles_OP = 4; /* Branch not taken */} }
void CPU8086_OP7A() {INLINEREGISTER signed char rel8;/*JP rel8 : (FLAG_PF=1)*/ rel8 = imm8(); modrm_generateInstructionTEXT("JP",0,REG_IP + rel8,PARAM_IMM16); /* JUMP to destination? */ if (FLAG_PF) {REG_IP += rel8; /* JUMP to destination? */ CPU_flushPIQ(); /*We're jumping to another address*/ CPU[activeCPU].cycles_OP = 16; /* Branch taken */} else { CPU[activeCPU].cycles_OP = 4; /* Branch not taken */} }
...
void CPU8086_OP7C() {INLINEREGISTER signed char rel8;/*JL rel8: (FLAG_SF!=FLAG_OF)*/ rel8 = imm8(); modrm_generateInstructionTEXT("JL",0,REG_IP + rel8,PARAM_IMM16); /* JUMP to destination? */ if (FLAG_SF!=FLAG_OF) {REG_IP += rel8; /* JUMP to destination? */ CPU_flushPIQ(); /*We're jumping to another address*/ CPU[activeCPU].cycles_OP = 16; /* Branch taken */} else { CPU[activeCPU].cycles_OP = 4; /* Branch not taken */} }
void CPU8086_OP7D() {INLINEREGISTER signed char rel8;/*JGE rel8 : (FLAG_SF=FLAG_OF)*/ rel8 = imm8(); modrm_generateInstructionTEXT("JGE",0,REG_IP + rel8,PARAM_IMM16); /* JUMP to destination? */ if (FLAG_SF==FLAG_OF) {REG_IP += rel8; /* JUMP to destination? */ CPU_flushPIQ(); /*We're jumping to another address*/ CPU[activeCPU].cycles_OP = 16; /* Branch taken */} else { CPU[activeCPU].cycles_OP = 4; /* Branch not taken */} }
void CPU8086_OP7E() {INLINEREGISTER signed char rel8;/*JLE rel8 : (FLAG_ZF|(FLAG_SF!=FLAG_OF))*/ rel8 = imm8(); modrm_generateInstructionTEXT("JLE",0,REG_IP + rel8,PARAM_IMM16); /* JUMP to destination? */ if ((FLAG_SF!=FLAG_OF) || FLAG_ZF) {REG_IP += rel8; /* JUMP to destination? */ CPU_flushPIQ(); /*We're jumping to another address*/ CPU[activeCPU].cycles_OP = 16; /* Branch taken */} else { CPU[activeCPU].cycles_OP = 4; /* Branch not taken */} }
...
void CPU8086_OP8B() {modrm_readparams(&params,1,0); modrm_debugger16(&params,0,1); modrm_generateInstructionTEXT("MOVW",16,0,PARAM_MODRM12); MODRM_src0 = 0; CPU8086_internal_MOV16(modrm_addr16(&params,0,0),modrm_read16(&params,1),2); }
...
void CPU8086_OPA3() {INLINEREGISTER word theimm = CPU_readOPw(); debugger_setcommand("MOVW [%s:%04X],AX",CPU_textsegment(CPU_SEGMENT_DS),theimm);/*MOV [imm16], AX*/ custommem = 1; customoffset = theimm; CPU8086_internal_MOV16(NULL,REG_AX,1);/*MOV [imm16], AX*/ custommem = 0; }
...
void CPU8086_OPA8() {INLINEREGISTER byte theimm = CPU_readOP(); modrm_generateInstructionTEXT("TESTB AL,",0,theimm,PARAM_IMM8);/*TEST AL,imm8*/ CPU8086_internal_TEST8(REG_AL,theimm,1);/*TEST AL,imm8*/ }
void CPU8086_OPA9() {INLINEREGISTER word theimm = CPU_readOPw(); modrm_generateInstructionTEXT("TESTW AX,",0,theimm,PARAM_IMM16);/*TEST AX,imm16*/ CPU8086_internal_TEST16(REG_AX,theimm,1);/*TEST AX,imm16*/ }
...
void CPU8086_OPB0() {INLINEREGISTER byte theimm = CPU_readOP(); modrm_generateInstructionTEXT("MOVB AL,",0,theimm,PARAM_IMM8);/*MOV AL,imm8*/ CPU8086_internal_MOV8(&REG_AL,theimm,4);/*MOV AL,imm8*/ }
void CPU8086_OPB1() {INLINEREGISTER byte theimm = CPU_readOP(); modrm_generateInstructionTEXT("MOVB CL,",0,theimm,PARAM_IMM8);/*MOV CL,imm8*/ CPU8086_internal_MOV8(&REG_CL,theimm,4);/*MOV CL,imm8*/ }
void CPU8086_OPB2() {INLINEREGISTER byte theimm = CPU_readOP(); modrm_generateInstructionTEXT("MOVB DL,",0,theimm,PARAM_IMM8);/*MOV DL,imm8*/ CPU8086_internal_MOV8(&REG_DL,theimm,4);/*MOV DL,imm8*/ }
void CPU8086_OPB3() {INLINEREGISTER byte theimm = CPU_readOP(); modrm_generateInstructionTEXT("MOVB BL,",0,theimm,PARAM_IMM8);/*MOV BL,imm8*/ CPU8086_internal_MOV8(&REG_BL,theimm,4);/*MOV BL,imm8*/ }
void CPU8086_OPB4() {INLINEREGISTER byte theimm = CPU_readOP(); modrm_generateInstructionTEXT("MOVB AH,",0,theimm,PARAM_IMM8);/*MOV AH,imm8*/ CPU8086_internal_MOV8(&REG_AH,theimm,4);/*MOV AH,imm8*/ }
void CPU8086_OPB5() {INLINEREGISTER byte theimm = CPU_readOP(); modrm_generateInstructionTEXT("MOVB CH,",0,theimm,PARAM_IMM8);/*MOV CH,imm8*/ CPU8086_internal_MOV8(&REG_CH,theimm,4);/*MOV CH,imm8*/ }
void CPU8086_OPB6() {INLINEREGISTER byte theimm = CPU_readOP(); modrm_generateInstructionTEXT("MOVB DH,",0,theimm,PARAM_IMM8);/*MOV DH,imm8*/ CPU8086_internal_MOV8(&REG_DH,theimm,4);/*MOV DH,imm8*/ }
void CPU8086_OPB7() {INLINEREGISTER byte theimm = CPU_readOP(); modrm_generateInstructionTEXT("MOVB BH,",0,theimm,PARAM_IMM8);/*MOV BH,imm8*/ CPU8086_internal_MOV8(&REG_BH,theimm,4);/*MOV BH,imm8*/ }
void CPU8086_OPB8() {INLINEREGISTER word theimm = CPU_readOPw(); modrm_generateInstructionTEXT("MOVW AX,",0,theimm,PARAM_IMM16);/*MOV AX,imm16*/ CPU8086_internal_MOV16(&REG_AX,theimm,4);/*MOV AX,imm16*/ }
void CPU8086_OPB9() {INLINEREGISTER word theimm = CPU_readOPw(); modrm_generateInstructionTEXT("MOVW CX,",0,theimm,PARAM_IMM16);/*MOV CX,imm16*/ CPU8086_internal_MOV16(&REG_CX,theimm,4);/*MOV CX,imm16*/ }
void CPU8086_OPBA() {INLINEREGISTER word theimm = CPU_readOPw(); modrm_generateInstructionTEXT("MOVW DX,",0,theimm,PARAM_IMM16);/*MOV DX,imm16*/ CPU8086_internal_MOV16(&REG_DX,theimm,4);/*MOV DX,imm16*/ }
void CPU8086_OPBB() {INLINEREGISTER word theimm = CPU_readOPw(); modrm_generateInstructionTEXT("MOVW BX,",0,theimm,PARAM_IMM16);/*MOV BX,imm16*/ CPU8086_internal_MOV16(&REG_BX,theimm,4);/*MOV BX,imm16*/ }
void CPU8086_OPBC() {INLINEREGISTER word theimm = CPU_readOPw(); modrm_generateInstructionTEXT("MOVW SP,",0,theimm,PARAM_IMM16);/*MOV SP,imm16*/ CPU8086_internal_MOV16(&REG_SP,theimm,4);/*MOV SP,imm16*/ }
void CPU8086_OPBD() {INLINEREGISTER word theimm = CPU_readOPw(); modrm_generateInstructionTEXT("MOVW BP,",0,theimm,PARAM_IMM16);/*MOV BP,imm16*/ CPU8086_internal_MOV16(&REG_BP,theimm,4);/*MOV BP,imm16*/ }
void CPU8086_OPBE() {INLINEREGISTER word theimm = CPU_readOPw(); modrm_generateInstructionTEXT("MOVW SI,",0,theimm,PARAM_IMM16);/*MOV SI,imm16*/ CPU8086_internal_MOV16(&REG_SI,theimm,4);/*MOV SI,imm16*/ }
void CPU8086_OPBF() {INLINEREGISTER word theimm = CPU_readOPw(); modrm_generateInstructionTEXT("MOVW DI,",0,theimm,PARAM_IMM16);/*MOV DI,imm16*/ CPU8086_internal_MOV16(&REG_DI,theimm,4);/*MOV DI,imm16*/ }
...
void CPU8086_OPFA(){modrm_generateInstructionTEXT("CLI",0,0,PARAM_NONE); FLAG_IF = 0;CPU[activeCPU].cycles_OP = 2; /*Special timing!*/}
void CPU8086_OPFB(){modrm_generateInstructionTEXT("STI",0,0,PARAM_NONE); FLAG_IF = 1;CPU[activeCPU].cycles_OP = 2; /*Special timing!*/}
...
void CPU8086_OP80() //GRP1 Eb,Ib
{
	...
	MODRM_src0 = 1;
	INLINEREGISTER byte imm = CPU_readOP();
	if (cpudebugger) //Debugger on?
	{
		modrm_debugger8(&params,0,1);
	}
...
void CPU8086_OP81() //GRP1 Ev,Iv
{
	...
	INLINEREGISTER word imm = CPU_readOPw();
	if (cpudebugger) //Debugger on?
	{
		modrm_debugger16(&params,0,1);
	}
...
CPU_Timings CPUInformation[0x100] = {
{1,0,0,1,0,0,0x01}, //00 ADD
{1,1,0,0,0,0,0x01}, //01
{1,0,0,0,0,0,0x01}, //02
{1,1,0,0,0,0,0x01}, //03
{0,0,0,0,0,1,0x04}, //04
{0,0,0,0,0,2,0x04}, //05
{0,0,0,0,0,0,0x08}, //06 PUSH ES
{0,0,0,0,0,0,0x10}, //07 POP ES
{1,0,0,1,0,0,0x01}, //08 OR
{1,1,0,1,0,0,0x01}, //09
{1,0,0,0,0,0,0x01}, //0A
{1,1,0,0,0,0,0x01}, //0B
{0,0,0,0,0,1,0x04}, //0C
{0,0,0,0,0,2,0x04}, //0D
{0,0,0,0,0,0,0x08}, //0E PUSH CS
{0,0,0,0,0,0,0x10}, //0F POP CS
{1,0,0,1,0,0,0x01}, //10 ADC
{1,1,0,0,0,0,0x01}, //11
{1,0,0,0,0,0,0x01}, //12
{1,1,0,0,0,0,0x01}, //13
{0,0,0,0,0,1,0x04}, //14
{0,0,0,0,0,2,0x04}, //15
{0,0,0,0,0,0,0x08}, //16 PUSH SS
{0,0,0,0,0,0,0x10}, //17 POP SS
{1,0,0,1,0,0,0x01}, //18 SBB
{1,1,0,0,0,0,0x01}, //19
{1,0,0,0,0,0,0x01}, //1A
{1,1,0,0,0,0,0x01}, //1B
{0,0,0,0,0,1,0x04}, //1C
{0,0,0,0,0,2,0x04}, //1D
{0,0,0,0,0,0,0x08}, //1E PUSH DS
{0,0,0,0,0,0,0x10}, //1F POP DS
{1,0,0,1,0,0,0x01}, //20 AND
{1,1,0,0,0,0,0x01}, //21
{1,0,0,0,0,0,0x01}, //22
{1,1,0,0,0,0,0x01}, //23
{0,0,0,0,0,1,0x04}, //24
{0,0,0,0,0,2,0x04}, //25
{0,0,0,0,0,0,0x00}, //26 ES prefix
{0,0,0,0,0,0,0x00}, //27 DAA
{1,0,0,1,0,0,0x01}, //28 SUB
{1,1,0,0,0,0,0x01}, //29
{1,0,0,0,0,0,0x01}, //2A
{1,1,0,0,0,0,0x01}, //2B
{0,0,0,0,0,1,0x04}, //2C
{0,0,0,0,0,2,0x04}, //2D
{0,0,0,0,0,0,0x00}, //2E CS prefix
{0,0,0,0,0,0,0x00}, //2F DAS
{1,0,0,1,0,0,0x01}, //30 XOR
{1,1,0,0,0,0,0x01}, //31
{1,0,0,0,0,0,0x01}, //32
{1,1,0,0,0,0,0x01}, //33
{0,0,0,0,0,1,0x04}, //34
{0,0,0,0,0,2,0x04}, //35
{0,0,0,0,0,0,0x00}, //36 SS prefix
{0,0,0,0,0,0,0x00}, //37 AAA
{1,0,0,1,0,0,0x01}, //38 CMP
{1,1,0,0,0,0,0x01}, //39
{1,0,0,0,0,0,0x01}, //3A
{1,1,0,0,0,0,0x01}, //3B
{0,0,0,0,0,1,0x04}, //3C
{0,0,0,0,0,2,0x04}, //3D
{0,0,0,0,0,0,0x00}, //3E DS prefix
{0,0,0,0,0,0,0x00}, //3F AAS
{0,0,0,0,0,0,0x00}, //40 INC REG
{0,0,0,0,0,0,0x00}, //41 INC REG
{0,0,0,0,0,0,0x00}, //42 INC REG
{0,0,0,0,0,0,0x00}, //43 INC REG
{0,0,0,0,0,0,0x00}, //44 INC REG
{0,0,0,0,0,0,0x00}, //45 INC REG
{0,0,0,0,0,0,0x00}, //46 INC REG
{0,0,0,0,0,0,0x00}, //47 INC REG
{0,0,0,0,0,0,0x00}, //48 DEC REG
{0,0,0,0,0,0,0x00}, //49 DEC REG
{0,0,0,0,0,0,0x00}, //4A DEC REG
{0,0,0,0,0,0,0x00}, //4B DEC REG
{0,0,0,0,0,0,0x00}, //4C DEC REG
{0,0,0,0,0,0,0x00}, //4D DEC REG
{0,0,0,0,0,0,0x00}, //4E DEC REG
{0,0,0,0,0,0,0x00}, //4F DEC REG
{0,0,0,0,0,0,0x10}, //50 PUSH REG
{0,0,0,0,0,0,0x10}, //51 PUSH REG
{0,0,0,0,0,0,0x10}, //52 PUSH REG
{0,0,0,0,0,0,0x10}, //53 PUSH REG
{0,0,0,0,0,0,0x10}, //54 PUSH REG
{0,0,0,0,0,0,0x10}, //55 PUSH REG
{0,0,0,0,0,0,0x10}, //56 PUSH REG
{0,0,0,0,0,0,0x10}, //57 PUSH REG
{0,0,0,0,0,0,0x20}, //58 POP REG
{0,0,0,0,0,0,0x20}, //59 POP REG
{0,0,0,0,0,0,0x20}, //5A POP REG
{0,0,0,0,0,0,0x20}, //5B POP REG
{0,0,0,0,0,0,0x20}, //5C POP REG
{0,0,0,0,0,0,0x20}, //5D POP REG
{0,0,0,0,0,0,0x20}, //5E POP REG
{0,0,0,0,0,0,0x20}, //5F POP REG
{0,0,0,0,0,1,0x00}, //60/70 JXX
{0,0,0,0,0,1,0x00}, //61/71 JXX
{0,0,0,0,0,1,0x00}, //62/72 JXX
{0,0,0,0,0,1,0x00}, //63/73 JXX
{0,0,0,0,0,1,0x00}, //64/74 JXX
{0,0,0,0,0,1,0x00}, //65/75 JXX
{0,0,0,0,0,1,0x00}, //66/76 JXX
{0,0,0,0,0,1,0x00}, //67/77 JXX
{0,0,0,0,0,1,0x00}, //68/78 JXX
{0,0,0,0,0,1,0x00}, //69/79 JXX
{0,0,0,0,0,1,0x00}, //6A/7A JXX
{0,0,0,0,0,1,0x00}, //6B/7B JXX
{0,0,0,0,0,1,0x00}, //6C/7C JXX
{0,0,0,0,0,1,0x00}, //6D/7D JXX
{0,0,0,0,0,1,0x00}, //6E/7E JXX
{0,0,0,0,0,1,0x00}, //6F/7F JXX
{0,0,0,0,0,1,0x00}, //60/70 JXX
{0,0,0,0,0,1,0x00}, //61/71 JXX
{0,0,0,0,0,1,0x00}, //62/72 JXX
{0,0,0,0,0,1,0x00}, //63/73 JXX
...
{0,0,0,0,0,1,0x00}, //6E/7E JXX
{0,0,0,0,0,1,0x00}, //6F/7F JXX
{1,0,0,0,0,1,0x00}, //80 GRP1
{1,0,0,0,0,2,0x00}, //81 GRP1
{1,0,0,0,0,1,0x00}, //82 GRP1=80
{1,0,0,0,0,1,0x00}, //83 GRP1
{1,0,0,0,0,0,0x00}, //84 TEST
{1,1,0,0,0,0,0x00}, //85 TEST
{1,0,0,0,1,0,0x01}, //86 XCHG
{1,1,0,0,1,0,0x01}, //87 XCHG
{1,0,0,1,0,0,0x01}, //88 MOV
{1,1,0,1,0,0,0x01}, //89 MOV
{1,0,1,0,0,0,0x01}, //8A MOV
{1,1,0,0,0,0,0x01}, //8B MOV
{1,1,2,1,0,0,0x01}, //8C MOV
{1,1,0,0,0,0,0x03}, //8D LEA
{1,1,2,0,0,0,0x01}, //8E MOV
{1,1,0,1,0,0,0x00}, //8F Undocumented GRP opcode POP
{0,0,0,0,0,0,0x00}, //90 NOP
{0,0,0,0,0,0,0x00}, //91 XCHG REG,AX
{0,0,0,0,0,0,0x00}, //92 XCHG REG,AX
{0,0,0,0,0,0,0x00}, //93 XCHG REG,AX
{0,0,0,0,0,0,0x00}, //94 XCHG REG,AX
{0,0,0,0,0,0,0x00}, //95 XCHG REG,AX
{0,0,0,0,0,0,0x00}, //96 XCHG REG,AX
{0,0,0,0,0,0,0x00}, //97 XCHG REG,AX
{0,0,0,0,0,0,0x00}, //98 CBW
{0,0,0,0,0,0,0x00}, //99 CWD
{0,0,0,0,0,3,0x00}, //9A Call Ap
{0,0,0,0,0,0,0x00}, //9B WAIT
{0,0,0,0,0,0,0x10}, //9C PUSHF
{0,0,0,0,0,0,0x20}, //9D POPF
{0,0,0,0,0,0,0x00}, //9E SAHF
{0,0,0,0,0,0,0x00}, //9F LAHF
{0,0,0,0,0,2,0x00}, //A0 MOV AL,[imm16]
{0,0,0,0,0,2,0x00}, //A1 MOV AX,[imm16]
{0,0,0,0,0,2,0x00}, //A2 MOV [imm16],AL
{0,0,0,0,0,2,0x00}, //A3 MOV [imm16],AX
{0,0,0,0,0,0,0x00}, //A4 MOVSB
{0,0,0,0,0,0,0x00}, //A5 MOVSW
{0,0,0,0,0,0,0x00}, //A6 CMPSB
{0,0,0,0,0,0,0x00}, //A7 CMPSW
{0,0,0,0,0,1,0x00}, //A8 TESTB AL
{0,0,0,0,0,2,0x00}, //A9 TESTW AX
{0,0,0,0,0,0,0x00}, //AA STOSB
{0,0,0,0,0,0,0x00}, //AB STOSW
{0,0,0,0,0,0,0x00}, //AC LODSB
{0,0,0,0,0,0,0x00}, //AD LODSW
{0,0,0,0,0,0,0x00}, //AE SCASB
{0,0,0,0,0,0,0x00}, //AF SCASW
{0,0,0,0,0,1,0x00}, //B0 MOV REG,imm8
{0,0,0,0,0,1,0x00}, //B1 MOV REG,imm8
{0,0,0,0,0,1,0x00}, //B2 MOV REG,imm8
{0,0,0,0,0,1,0x00}, //B3 MOV REG,imm8
{0,0,0,0,0,1,0x00}, //B4 MOV REG,imm8
{0,0,0,0,0,1,0x00}, //B5 MOV REG,imm8
{0,0,0,0,0,1,0x00}, //B6 MOV REG,imm8
{0,0,0,0,0,1,0x00}, //B7 MOV REG,imm8
{0,0,0,0,0,2,0x00}, //B8 MOV REG,imm16
{0,0,0,0,0,2,0x00}, //B9 MOV REG,imm16
{0,0,0,0,0,2,0x00}, //BA MOV REG,imm16
{0,0,0,0,0,2,0x00}, //BB MOV REG,imm16
{0,0,0,0,0,2,0x00}, //BC MOV REG,imm16
{0,0,0,0,0,2,0x00}, //BD MOV REG,imm16
{0,0,0,0,0,2,0x00}, //BE MOV REG,imm16
{0,0,0,0,0,2,0x00}, //BF MOV REG,imm16
{0,0,0,0,0,0,0x00}, //C0 Unknown opcode
{0,0,0,0,0,0,0x00}, //C1 Unknown opcode
{0,0,0,0,0,2,0x00}, //C2 RET imm16
...
{0,0,0,0,0,0,0x00}, //CC INT3
{0,0,0,0,0,1,0x00}, //CD INT
{0,0,0,0,0,0,0x00}, //CE INTO
{0,0,0,0,0,0,0x00}, //CF IRET
{1,0,0,1,0,0,0x00}, //D0 GRP2
{1,1,0,1,0,0,0x00}, //D1 GRP2
{1,0,0,1,0,0,0x00}, //D2 GRP2
{1,1,0,1,0,0,0x00}, //D3 GRP2
{0,0,0,0,0,1,0x00}, //D4 AAM
{0,0,0,0,0,1,0x00}, //D5 AAD
{0,0,0,0,0,0,0x00}, //D6 SALC
{0,0,0,0,0,0,0x00}, //D7 XLAT
{1,0,0,0,0,0,0x00}, //D8 <COOP ESC>
{1,0,0,0,0,0,0x00}, //D9 <COOP ESC>
{1,0,0,0,0,0,0x00}, //DA <COOP ESC>
{1,0,0,0,0,0,0x00}, //DB <COOP ESC>
{1,0,0,0,0,0,0x00}, //DC <COOP ESC>
{1,0,0,0,0,0,0x00}, //DD <COOP ESC>
{1,0,0,0,0,0,0x00}, //DE <COOP ESC>
{1,0,0,0,0,0,0x00}, //DF <COOP ESC>
{0,0,0,0,0,1,0x00}, //E0 LOOPNZ
{0,0,0,0,0,1,0x00}, //E1 LOOPZ
{0,0,0,0,0,1,0x00}, //E2 LOOP
{0,0,0,0,0,1,0x00}, //E3 JCXZ
{0,0,0,0,0,1,0x00}, //E4 IN AL,imm8
{0,0,0,0,0,1,0x00}, //E5 IN AX,imm8
{0,0,0,0,0,1,0x00}, //E6 OUT imm8,AL
{0,0,0,0,0,1,0x00}, //E7 OUT imm8,AX
{0,0,0,0,0,2,0x00}, //E8 CALL imm16
{0,0,0,0,0,2,0x00}, //E9 JMP imm16
{0,0,0,0,0,3,0x00}, //EA JMP Ap
{0,0,0,0,0,1,0x00}, //EB JMP imm8
{0,0,0,0,0,0,0x00}, //EC IN AL,DX
{0,0,0,0,0,0,0x00}, //ED IN AX,DX
{0,0,0,0,0,0,0x00}, //EE OUT DX,AL
{0,0,0,0,0,0,0x00}, //EF OUT DX,AX
{0,0,0,0,0,0,0x00}, //F0: LOCK prefix
{0,0,0,0,0,0,0x00}, //F1: Undefined and reserved opcode
{0,0,0,0,0,0,0x00}, //F2 REPNZ prefix
{0,0,0,0,0,0,0x00}, //F3 REPZ prefix
{0,0,0,0,0,0,0x00}, //F4 HLT
{0,0,0,0,0,0,0x00}, //F5 CMC
{1,0,0,0,0,0,0x00}, //F6 Grp3a Eb Uses writeback with REG 2&3 only! REG 0&1 also have an immediate byte parameter!
{1,1,0,0,0,0,0x00}, //F7 Grp3b Ev See opcode F6(Grp3a Eb), but with word values for all cases!
{0,0,0,0,0,0,0x00}, //F8 CLC
{0,0,0,0,0,0,0x00}, //F9 STC
{0,0,0,0,0,0,0x00}, //FA CLI
{0,0,0,0,0,0,0x00}, //FB STI
{0,0,0,0,0,0,0x00}, //FC CLD
{0,0,0,0,0,0,0x00}, //FD STD
{1,0,0,1,0,0,0x00}, //FE GRP4 Eb Case 0&1 read and write back. Case 7 takes immediate operands(Special callback instruction in this emulation only).
{1,1,0,1,0,0,0x00} //FF GRP5 Various operations depending on REG.
};